      ...
      >
        <div className="scatterplot-container">
          ...
          <div style={{ margin: '0 50px' }}>
            ...
            <p> 949 cancer cell lines, originating from 28 different tissue types, were analyzed using mass spectrometry to determine the quantity of 8,498 proteins for each cell line.  Cell lines originating from the haematopoietic and lymphoid tissues were most commonly examined.</p>
            ...
            <p> In the study, proteins enriched in certain cell types were identified. These cell-type enriched proteins were defined as any protein quantified in 50% or more of cell lines from no more than two tissue types and 35% or less of cell lines from all remaining tissues, considering only tissues represented by at least 10 cell lines. As shown in the graph, cell lines from hematopoietic and lymphoid, peripheral nervous system, and skin cell types exhibited the highest numbers of these proteins. Proteins encoded by genes representing gene ontology terms for lymphocyte activation, neuron projection, and pigmentation were identified in each of these cell types, respectively. Additionally, the researchers observed that cell type-enriched proteins had a higher correlation between the transcriptome and proteome than other proteins, suggesting that these represent cell type-specific processes that are more highly conserved between transcription and translation. Consequently, the authors found that the data indicate a general alignment of the proteomic data with cell lineage, revealing patterns of protein expression consistent with certain cancer cell types of origin.</p>
            ...
            <div>
              ...
              <p style={{ width: "1100px" }}>
                The ProCan team also explored  protein-drug associations. Amongst the most significant findings (FDR &lt;5%), they discovered 57 drugs linked to the protein abundance of their respective canonical targets . For instance, they observed a decrease in EGFR protein abundance when exposed to its inhibitor gefitinib
                A similar trend was found with MET protein abundance and its corresponding drug response.
                Moreover, their investigation revealed a significant negative correlation between ERBB2 and lapatinib, a tyrosine kinase inhibitor with dual targeting of EGFR and HER2. These findings aligned with previous discoveries in proteomic research.
                Expanding their analysis, the team identified notable associations between another 132 drugs and proteins functionally connected to their targets. These connections were validated by their proximity within the STRING PPI network.
                Overall, the team observed that the majority of significant drug-protein target associations exhibited a negative effect size, suggesting increased sensitivity of cell lines to a drug when the drug's target is more abundant. <br /><br />
                The graph below shows associations ((FDR  &lt;1% or  Nc_FDR  &lt;1%) and ABS(Beta &gt; 0.1 or Nc_Beta &gt; 0.1)) between protein measurements and drug responses - this graph uses the same axis labels as Figure 4A from the paper of the ProCan Team. Each association is represented using the linear regression effect size (beta) and its statistical significance (log ratio test), and colored according to the distance between the target of the drug and the associated protein in a PPI network assembled from STRING. T denotes the associated protein is a canonical target of the drug; numbers represent the minimal number of interactions separating the drug  targets to the associated proteins; and the symbol '-' denotes associations for which no path was found.</p>
